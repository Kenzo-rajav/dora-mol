CopyrightCopyright (C) 2020 Yusuf Usta.
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [dora-mol] --*' + 
                                    '\n*dora-mol an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [dora-mol] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
